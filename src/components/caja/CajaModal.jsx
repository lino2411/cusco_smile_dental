...
export default function CajaModal({ visible, onClose, onGuardado, usuarioId }) {
    ...
    const handleSubmit = useCallback(async (e) => {
        ...
        try {
            ...
            setForm({ descripcion: '', monto: '', tipo_movimiento: 'egreso', nota: '' });
            onGuardado();
            onClose();
        } catch (error) {
            Swal.fire({
    ...
    }, [form, usuarioId, onGuardado, onClose]);
                ...
                <form className="p-6 space-y-4" onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Ej: Compra de insumos, Ajuste de caja, etc."
                            required
                            disabled={loading}
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            step="0.01"
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-smile_500 outline-none"
                            placeholder={form.tipo_movimiento === 'ajuste' ? '100 o -100' : '0.00'}
                            required
                            disabled={loading}
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-smile_500 outline-none text-sm min-w-[120px]"
                            disabled={loading}
                        >
